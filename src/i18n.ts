export const translations = {
  'zh-CN': {
    ...
    scene3d: {
      ariaLabel: '3D 视图控制',
      emptyState: '显示机器人 hold 高度、物体位置和 taut 连接线',
      groundRobotLegend: 'r_i 地面位置',
      holdPointLegend: 'p_i hold 高度',
      legendAriaLabel: '3D 图例',
      objectLegend: 'po 物体位置',
      resetView: '重置视图',
      tautLineLegend: 'taut p_i-po',
      title: '3D 视图',
  ...
  'en-US': {
    ...
    scene3d: {
      ...
      emptyState: 'Showing robot hold height, object positions, and taut lines',
      groundRobotLegend: 'r_i ground',
      holdPointLegend: 'p_i hold height',
